...
export default function MainProducCard() {
  return (
    <>
        <div class="lg:w-1/4 md:w-1/2 p-4 mx-4 my-7 w-full h-full bg-white shadow rounded">
                            <div
                            ...
                            >
                                ...
                                <div>
                                    <span
                                        className="uppercase text-xs bg-green p-2 font-Raleway rounded text-white opacity-50 font-medium select-none"
                                    >
                                        Available
                                    </span>
                                </div>
                            ...
                            <div className="p-4 flex flex-col items-center font-Raleway">
                                ...
                                <h1 className="text-gray-800 text-center mt-1 font-semibold">Item name</h1>
                                <p className="text-center text-green font-bold mt-5">Rs.299 / 3 days</p>
                                ...
                                <button
                                    className="p-2 font-Raleway bg-green text-white rounded hover:opacity-90 disabled:opacity-50 mt-7 w-full flex items-center justify-center"
                                >
                                    Add to Cart
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
