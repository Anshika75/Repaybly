...
export default function Form() {
  return (
    <>
        <div className="h-screen grid grid-cols-3 font-Poppins">
        ...
        <div className="col-span-1 bg-white lg:block hidden">
                ...
                <li className="grid grid-cols-6 gap-2 border-b-1">
                    ...
                    <div className="col-span-2 pt-3">
                        <div className="flex items-center space-x-2 text-sm justify-between">
                            ...
                            <span className="text-maroon font-semibold inline-block">€61.98</span>
                        </div>
                    </div>
                </li>
                <li className="grid grid-cols-6 gap-2 border-b-1">
                    ...
                    <div className="col-span-2 pt-3">
                        <div className="flex items-center space-x-2 text-sm justify-between">
                            ...
                            <span className="text-maroon font-semibold inline-block">€785</span>
                        </div>
                    </div>
                </li>
            </ul>
            <div className="px-8 border-b">
                <div className="flex justify-between py-4 text-gray-600">
                    <span>Subtotal</span>
                    <span className="font-semibold text-maroon">€846.98</span>
                </div>
                <div className="flex justify-between py-4 text-gray-600">
                    <span>Shipping</span>
                    <span className="font-semibold text-maroon">Free</span>
                </div>
            </div>
